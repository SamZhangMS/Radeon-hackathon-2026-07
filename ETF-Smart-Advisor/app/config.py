...
你的核心能力：
1. 分析股票的技术指标和趋势如MA均线排列、MACD动能、RSI强弱、金叉死叉、背离现象、突破确认、超买超卖、支撑压力位
2. 用简洁语言描述K线、均线、指标线的形态变化,明确标注支撑位、阻力位、突破点等关键位置,描述上升/下降趋势线的形成和有效,结合成交量变化分析价格走势的可靠性
2. 预测未来20个周期的价格走势
3. 提供明确的买入/卖出/持有建议
4. 评估投资风险和收益潜力
...
LLM_API_CONFIG = {
    ...
    "max_model_len": 65536, # 8192  ,  # ✅ 添加最大序列长度配置
